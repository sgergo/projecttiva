...
#define GDO0PINPERIPHERIAL 					SYSCTL_PERIPH_GPIOB
#define GDO0PINPERIPHERIALBASE				GPIO_PORTB_BASE
#define GDO0PIN								GPIO_PIN_2
#define GDO0INTPIN							GPIO_INT_PIN_2
#define GDO0INT 							INT_GPIOB

#define GDO2PINPERIPHERIAL 					SYSCTL_PERIPH_GPIOB
#define GDO2PINPERIPHERIALBASE				GPIO_PORTB_BASE
#define GDO2PIN								GPIO_PIN_5
#define GDO2INTPIN							GPIO_INT_PIN_5
#define GDO2INT 							INT_GPIOB
